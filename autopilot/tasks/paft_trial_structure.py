"""This module defines the PaftTrialStructure example task.

This illustrates the mechanism for passing through stages and returning
trial data.
"""
...
TASK = 'PaftTrialStructure'


## Define the Task
class PaftTrialStructure(Task):
    ...
    * autopilot.core.subject.Subject.data_thread - how data is saved
    ...
    def __init__(self, stage_block, current_trial, step_name, task_type, 
        ...
        """Initialize a new PaftTrialStructure Task. 
    ...
    def init_hardware(self, *args, **kwargs):
        ...
        """
        super(PaftTrialStructure, self).init_hardware(*args, **kwargs)
    ...
    def end(self, *args, **kwargs):
        ...
        super(PaftTrialStructure, self).end(*args, **kwargs)
