    ...
    def initalize_sounds(self):
        ...
        self.noise_bursts = [
            autopilot.stim.sound.sounds.Tone(
                frequency=100, amplitude=1, duration=1000),
            autopilot.stim.sound.sounds.Tone(
                frequency=1000, amplitude=1, duration=1000),
            autopilot.stim.sound.sounds.Tone(
                frequency=3000, amplitude=1, duration=1000),
            autopilot.stim.sound.sounds.Tone(
                frequency=6000, amplitude=1, duration=1000),
            autopilot.stim.sound.sounds.Tone(
                frequency=10000, amplitude=1, duration=1000),
            autopilot.stim.sound.sounds.Tone(
                frequency=30000, amplitude=1, duration=1000),
            autopilot.stim.sound.sounds.Tone(
                frequency=40000, amplitude=1, duration=1000),                
            autopilot.stim.sound.sounds.Tone(
                frequency=50000, amplitude=1, duration=1000),                                
            autopilot.stim.sound.sounds.Tone(
                frequency=60000, amplitude=1, duration=1000),                
            autopilot.stim.sound.sounds.Tone(
                frequency=70000, amplitude=1, duration=1000),                
            autopilot.stim.sound.sounds.Tone(
                frequency=80000, amplitude=1, duration=1000),                
            autopilot.stim.sound.sounds.Tone(
                frequency=90000, amplitude=1, duration=1000),                
