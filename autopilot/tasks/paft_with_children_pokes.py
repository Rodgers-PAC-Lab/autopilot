"""This module defines Paft_With_Children_Pokes task.

This is a stripped-down task that only receives information about
pokes from each child.
"""
...
## Define the Task
class Paft_With_Children_Pokes(Task):
