...
class PaftWithChildrenPokesAndSoundChild(children.Child):
    """Define the child task associated with PaftWithChildrenPokesAndSound"""
    # PARAMS to accept
    PARAMS = odict()
    ...
    def __init__(self, stage_block, task_type, subject, child, reward):
        """Initialize a new PaftWithChildrenPokesAndSoundChild
